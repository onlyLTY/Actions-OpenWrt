...
echo '::set-output name=matrix::[{"name":"lede","branch":"master","addr":"https://github.com/coolsnowwolf/lede"},{"name":"openwrt","branch":"openwrt-22.03","addr":"https://github.com/openwrt/openwrt"}]'
