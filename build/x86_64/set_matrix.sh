...
echo '::set-output name=matrix::[{"name":"lede","branch":"master","addr":"https://github.com/coolsnowwolf/lede"},{"name":"openwrt","branch":"masteer","addr":"https://github.com/openwrt/openwrt"}]'
